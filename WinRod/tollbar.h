...
#define IDM_2D_SETTINGS                 122
#define IDM_GRID2D	                    125
#define IDM_MOVI                        124
...
static TBBUTTON tbButton[] =      
{
  ...
  {2, IDM_2D_SETTINGS,		TBSTATE_ENABLED,										TBSTYLE_BUTTON,   0, -1},
  {0, 0,					TBSTATE_ENABLED,										TBSTYLE_SEP,      0, -1},
  {3, IDM_GRID2D,			TBSTATE_ENABLED | TBSTATE_PRESSED | TBSTATE_CHECKED,	TBSTYLE_CHECK,    0, -1},
  {0, 0,					TBSTATE_ENABLED,										TBSTYLE_SEP,      0, -1},
  {4, IDM_MOVI,				TBSTATE_ENABLED,										TBSTYLE_BUTTON,   0, -1},
  {0, 0,					TBSTATE_ENABLED,										TBSTYLE_SEP,      0, -1},
  {5, IDM_ARROW,			TBSTATE_ENABLED | TBSTATE_CHECKED,						BTNS_CHECKGROUP , 1, -1},
  {6, IDM_ZOOM,				TBSTATE_ENABLED,										BTNS_CHECKGROUP,  0, -1},
  {7, IDM_SCALE_MOVE,		TBSTATE_ENABLED,										BTNS_CHECKGROUP,  0, -1},
  {0, 0,					TBSTATE_ENABLED,										TBSTYLE_SEP,      0, -1},
  {8, IDM_LIN,				TBSTATE_ENABLED,										BTNS_CHECKGROUP,  0, -1},
  {9, IDM_LOG,				TBSTATE_ENABLED | TBSTATE_CHECKED,						BTNS_CHECKGROUP,  0, -1},
  {0, 0,					TBSTATE_ENABLED,										TBSTYLE_SEP,      0, -1},
  {10, IDM_LINE,			TBSTATE_ENABLED | TBSTATE_CHECKED,						BTNS_CHECKGROUP,  0, -1},
  {11, IDM_POINTS,			TBSTATE_ENABLED,										BTNS_CHECKGROUP,  0, -1},
  {0, 0,					TBSTATE_ENABLED,										TBSTYLE_SEP,      0, -1},
  {12, IDM_SUR,				TBSTATE_ENABLED,										TBSTYLE_CHECK,    0, -1},
  {13, IDM_BUL,				TBSTATE_ENABLED | TBSTATE_PRESSED | TBSTATE_CHECKED,	TBSTYLE_CHECK,    0, -1},
  {14, IDM_BOT,				TBSTATE_ENABLED | TBSTATE_PRESSED | TBSTATE_CHECKED,	TBSTYLE_CHECK,    0, -1},
  {0, 0,					TBSTATE_ENABLED,										TBSTYLE_SEP,      0, -1},
  {15, IDM_DATA,			TBSTATE_ENABLED | TBSTATE_PRESSED | TBSTATE_CHECKED,	TBSTYLE_CHECK,    0, -1},
  {16, IDM_ERROR,			TBSTATE_ENABLED | TBSTATE_PRESSED | TBSTATE_CHECKED,	TBSTYLE_CHECK,    0, -1},
  {0, 0,					TBSTATE_ENABLED,										TBSTYLE_SEP,      0, -1}
...
void Tooltip2D(LPARAM lParam){
	...
	{
 		case IDM_FILE_OPEN:
			lpttt->lpszText = L"Open files eg. with data";
			break;
		case IDM_FILE_SAVE:
