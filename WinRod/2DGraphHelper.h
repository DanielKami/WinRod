...
#define			SHIFT_FACTOR				0.01				//factor to set the shift of scale acoording to the mouse position
...
//Set scale windows
#define ID_TAB_SCALE_X	 0
#define ID_TAB_SCALE_Y	 1
#define ID_TAB_TITLE	 2
#define ID_TAB_TITLE_X   3
#define ID_TAB_TITLE_Y   4
...
public:
	...
	typedef struct tag_t
	{
		...
		double InPlaneL;				//l value for inplane data
	...
	typedef struct GRAPHSETTINGS_t
	{
		double bottom, top, left, right;
		//X section
		double majorXticks; //number of major ticks
		double minorXticks;//number of minor ticks
		int Xprecision; //number of digits after coma
		bool flag_autoXprecision;
		bool flag_autoXscaleMin;
		bool flag_autoXscaleMax;
		bool flag_autoXmajorTicks;
		bool flag_autoXminorTicks;
		//Y section
		double majorYticks; //number of major ticks
		double minorYticks;//number of minor ticks
		int Yprecision; //number of digits after coma
		bool flag_autoYprecision;
		bool flag_autoYscaleMin;
		bool flag_autoYscaleMax;
		bool flag_autoYmajorTicks;
		bool flag_autoYminorTicks;
		WCHAR *Title;
		WCHAR *TitleX;
		WCHAR *TitleY;
		LOGFONT MyFont_str, MyFont_strX, MyFont_strY;
		HFONT MyFont, MyFont_Small, MyFont_X, MyFont_Y;
		int SelectedMenu;
	}
	GRAPHSETTINGS;

	GRAPHSETTINGS XYMinMax;
	...
	static INT_PTR CALLBACK SettingsScale(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam);
	...
	static void SetDlgItemReal(HWND hDlg, int nIDD, double Value, WCHAR FORMAT[10] = L"%5.7f");
